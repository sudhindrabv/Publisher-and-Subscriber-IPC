...
int (*call_vec[])(void) = {
	...
	no_sys,		/* 42 = pipe	*/
	do_times,	/* 43 = times	*/
	topic_init,		/* 44 = unused	*/
	topic_create,		/* 45 = unused	*/
	do_set,		/* 46 = setgid	*/
	do_get,		/* 47 = getgid	*/
	no_sys,		/* 48 = (signal)*/
	topic_lookup,		/* 49 = unused	*/
	no_sys,		/* 50 = lstat	*/
	no_sys,		/* 51 = (stat)	*/
	no_sys,		/* 52 = (fstat)	*/
	no_sys,		/* 53 = (lstat)	*/
	no_sys,		/* 54 = ioctl	*/
	no_sys,		/* 55 = fcntl	*/
	topic_publisher,		/* 56 = unused	*/
	topic_subscriber,		/* 57 = unused	*/
	topic_publish,		/* 58 = unused	*/
	do_exec,	/* 59 = execve	*/
	no_sys,		/* 60 = umask	*/
	no_sys,		/* 61 = chroot	*/
	do_set,		/* 62 = setsid	*/
	...
	topic_retrieve,		/* 69 = unused	*/
	topic_overview,		/* 70 = unused	*/
